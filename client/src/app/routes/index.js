...
export const ORGANISATION_CRUD_KIDS = '/organisation/crud/kids';
export const ORGANISATION_CRUD_SUPERVISOR = '/organisation/crud/supervisor';
...
// fiches
export const SUPERVISOR_MOUNTAIN = '/supervisor/Begeleidingslijn';
